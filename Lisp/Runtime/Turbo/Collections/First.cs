...
public class First : ITurboFunction
{
    ...
    public BaseLispValue Execute(Node function, List<Node> arguments, LispScope scope)
    {
        ...
        if (value is not ICollectionLispValue collection) throw Report.Error(new WrongArgumentTypeReportMessage("First expects it's argument to be a collection type"), function.Location);
